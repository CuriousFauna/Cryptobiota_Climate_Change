# ><><><><><><><><><><><><><><><><><><><><><><><><><><><><><
# The below code was sourced to produce the Venn Diagrams
# ><><><><><><><><><><><><><><><><><><><><><><><><><><><><><
...
###########################################
vennPlot <- function(counts=counts, mymain="", mysub="default", setlabels="default", yoffset=seq(0,10,by=0.34), ccol=rep(1,31), colmode=1, lcol=c("#FF0000", "#008B00", "#0000FF", "#FF00FF", "#CD8500"), lines=c("#FF0000", "#008B00", "#0000FF", "#FF00FF", "#CD8500"), mylwd=3, diacol=1, type="ellipse", ccex=1.0, lcex=1.0, sepsplit="_", ...) {
