...
The demultiplexed fastq files are named ArmsMeso1 thru 22. There are two fastq files per sample, one forward (ex. ArmsMeso1_R1) and one reverse (ex. ArmsMeso1_R2). The treatment names that correspond to the ArmsMeso numbers are in the MetaData_ARMS.csv file located in the Data folder.
